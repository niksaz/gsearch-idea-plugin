...
public class GGExprImpl extends ASTWrapperPsiElement implements GGExpr {

  public GGExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GVisitor visitor) {
    visitor.visitGExpr(this);
  }
  ...
  @Override
  @NotNull
  public List<GPlusExpr> getPlusExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GPlusExpr.class);
  }
